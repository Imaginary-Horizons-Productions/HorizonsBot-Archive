...
exports.commandSets = [
	new CommandSet("HorizonsBot Commands", "The general use commands. Required permissions are listed in (parenthesis) at the beginning of the description.",
		['about.js', 'commands.js', 'data-policy.js', "list.js", "join.js", "leave.js", "roll.js", "timestamp.js", "at-channel.js", "version.js"]),
	new CommandSet("Server Informantion", "To get a message's id, enable developer mode (User Settings > Appearance > Developer Mode), then right-click the message and select \"Copy ID\".",
		['rules.js', 'roles.js', 'support.js', 'press-kit.js']),
